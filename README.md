...
class ChatSystem {
          ...
          <div id="welcomeMessage" class="message bot-message welcome-message">
              ...
              <div class="message-content">
                  ...
                  <ul>
                      ...
                      <li>Service Bookings & Information</li>
                  </ul>
  ...
  async handleUserInput() {
      ...
      // Setup action button listeners after displaying message
  ...
  createPromptResponse(promptData) {
      const actionButtons = promptData.actionButtons.map(btn => `
      ...
      const infoButton = `
          <button class="info-button" onclick="showDetailedInfo(this)">
              <i class="fas fa-info-circle"></i>
          </button>
      `;

      const detailedInfo = Object.entries(promptData.detailedInfo)
          .map(([section, items]) => `
      ...
      return `
          <div class="prompt-response">
              ...
              ${infoButton}
              <div class="detailed-info hidden">${detailedInfo}</div>
          </div>
      `;
  }
...
function showDetailedInfo(button) {
  const infoPanel = button.parentElement.querySelector('.detailed-info');
